...
func ContractsFusdCdc() (*asset, error) {
	bytes, err := ContractsFusdCdcBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "../../../contracts/FUSD.cdc", size: 7395, mode: os.FileMode(0644), modTime: time.Unix(1634053955, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"../../../contracts/FUSD.cdc": ContractsFusdCdc,
}
		...
		"..": {nil, map[string]*bintree{
			"..": {nil, map[string]*bintree{
				"contracts": {nil, map[string]*bintree{
					"FUSD.cdc": {ContractsFusdCdc, map[string]*bintree{}},
				}},
			}},
		}},
	}},
